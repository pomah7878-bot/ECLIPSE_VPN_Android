...
fun MainScreen(
    ...
    ModalNavigationDrawer(
        ...
        // ECLIPSE: чёрно-золотая айдентика бренда — вместо испробованного
        // и отклонённого фиолетового градиента (не подошёл под собственный
        // стиль "затмения": тёмный диск + золотое сияние). Только в тёмной
        // теме, в светлой обычный Material-фон без переопределения
        // (верхнюю панель по-прежнему не трогаем — сложный компонент с
        // поведением при прокрутке).
